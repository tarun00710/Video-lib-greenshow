...
const Footer = () => {
    return (
        <div className="footer-section">
            <p>Created by <small><i class="fa fa-copyright" aria-hidden="true"></i> Tarun. All rights reserved</small></p>
            ...
            <div className="footer-icons">
                ...
                <a href="https://github.com/tarun00710"><i class="fa  fa-github" aria-hidden="true"></i></a>
                </div>
        </div>
    )
}
